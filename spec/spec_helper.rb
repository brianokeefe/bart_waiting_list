...
RSpec.configure do |config|
  config.before(:each) do
    stub_request(:get, 'https://www.select-a-spot.com/bart/').
      to_return(:status => 200, :body => File.read('fixtures/mock_home_page.html'), :headers => {})
    ...
    stub_request(:get, 'https://www.select-a-spot.com/bart/waiting_lists/').
      to_return(:status => 200, :body => File.read('fixtures/mock_waiting_list_page.html'), :headers => {})
  end
end
